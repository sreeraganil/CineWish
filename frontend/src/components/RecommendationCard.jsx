    ...
    >
      ...
      <div className="relative h-32 sm:h-36 md:h-40 overflow-hidden bg-gray-800">
        ...
        <div className="absolute top-2 right-2">
          <span className="bg-teal-500/90 md:backdrop-blur-sm text-white text-[10px] font-bold px-2.5 py-1 rounded-full uppercase shadow-lg border border-teal-400/30">
            {media_type}
          </span>
        </div>
        ...
        {rating && parseFloat(rating) > 0 && (
          <div className="absolute top-2 left-2">
            <div className="flex items-center gap-1 bg-black/60 md:backdrop-blur-sm px-2 py-1 rounded-full">

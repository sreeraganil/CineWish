...
const StatsSection = () => {
  ...
  return (
    <section className="bg-gray-950 text-white p-4">
      <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
        <div className="bg-gray-900 border border-gray-800 p-6 rounded-xl shadow hover:shadow-teal-500/10 transition hover:scale-105">
